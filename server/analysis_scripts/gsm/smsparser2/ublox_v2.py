...
def ublox_v2_parser(sms):
    ...
    logger_name = active_sites.logger_name.loc[active_sites['logger_name'].str.startswith(usplit_site.lower())].\
                    loc[active_sites['logger_name'].str.endswith(usplit_no.lower())].iloc[0]
